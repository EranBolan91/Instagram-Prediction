...
if __name__ == "__main__":
    ...
    print(post_text)
    img = wait.until(EC.element_to_be_clickable((By.CLASS_NAME, '/html/body/div[6]/div[3]/div/article/div/div[1]/div/div[1]/div[2]/div/div/div/ul/li[2]/div/div/div/div[1]/img'))).get_attribute("srcset")
    print(img)
